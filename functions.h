...
namespace Functions
{
    ...
    namespace PlayerController {
        void* (*ServerAcknowledgePosession)(APlayerController* a1, APlayerPawn_Athena_C* a2);
        __int64 (*ReplicateMoveToServer)(UCharacterMovementComponent* Component, float DeltaTime, FVector& NewAcceleration);
    }
    ...
    namespace LoadMap
    {
        static UNetDriver* (*CreateNetDriver)(UGameEngine*, UWorld* World, FName NetDriverDefinition);
        static void (*LoadMap)(UGameEngine*, void* WorldContext, FURL URL, void* Pending, void* Error);
    }
